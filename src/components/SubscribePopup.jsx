					...
					{subscribed ? (
						...
						<div className="flex flex-col items-center transition-opacity duration-500">
							...
							<p className="mt-6 text-xs text-gray-50 leading-relaxed">
								By submitting your email address, you are signing up to receive Coinbase Bytes communications to your inbox. For information on how we use your data see <a href="https://www.coinbase.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-60 hover:underline">coinbase.com/legal/privacy</a>.
							</p>
						</div>
					)}
				</div>

...
const MENUS = {
  Individuals: {
    ...
    featured: {
      ...
      description: "The next chapter of CryptoBase. Live on X 12/17.",
      linkText: "Learn more",
      href: "#",
    },
  },
    ...
    cols: [
      [
        ...
        },
        {
          ...
          desc: "List your asset on CryptoBase",
          href: "#",
        },
      ],
      [
  ...
  Developers: {
    cols: [
      {
        header: { label: "CryptoBase Developer Platform", href: "#" },
        items: [
          {
            icon: <EyeIcon />,
            title: "Payments",
          ...
          },
          {
            icon: <EarnIcon />,
            title: "Stablecoins",
            desc: "Access USDC and CryptoBase Custom Stablecoins",
            href: "#",
          },
        ],
      },
    ...
    featured: {
      ...
      description: "Discover CryptoBase's complete crypto-as-a-service platform.",
      linkText: "Learn more",
      href: "#",
    },
  },
    ...
    cols: [
      [
        ...
        },
        {
          icon: <NewsIcon />,
          title: "Blog",
          desc: "Read the latest from CryptoBase",
          href: "#",
        },
      ],
      [
    ...
    featured: {
      image: (
        <img
          ...
          alt="About CryptoBase"
          className="w-full h-full object-cover"
        />
      ),
      title: "Learn all about CryptoBase:",
            ...
            <div key={i} className="flex-1 min-w-0">
              {hasSectionHeaders ? (
                <>
                  {col.header && (
                    <NavSectionHeader
                      href={col.header.href}
                      className={
                        col.header.href?.startsWith("http")
                          ? "_blank"
                          : undefined
                      }
                    >
        ...
        <nav className="flex items-center justify-between h-20 gap-4">
              ...
              {navLinks.map((link) => (
                <li key={link}>
                  <a
                    ...
                    className={`text-label-1 px-3 py-2.5 rounded-lg transition-colors whitespace-nowrap ${activeMenu === link
          ...
          {searchActive ? (
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2 w-[300px] h-10 px-4 rounded-full border-2 border-blue-60 bg-white">
                ...
                >
                  <path
                    fill="#5B616E"
                    d="M9.867 11.57a5.75 5.75 0 1 1 1.697-1.697l3.425 3.425-1.697 1.697zm.222-4.825a3.35 3.35 0 1 0-6.7 0 3.35 3.35 0 0 0 6.7 0"
                  />
                </svg>
                <input
                  ref={searchInputRef}
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={openSearch}
                className="hidden md:flex w-11 h-11 items-center justify-center rounded-full bg-gray-10 hover:bg-gray-15 transition-colors"
              >
              ...
              <div className="relative">
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path
                      fill="#0A0B0D"
                      d="M14.99 7.995a7.002 7.002 0 1 1-14.003 0 7.002 7.002 0 0 1 14.003 0m-6.794 5.397h-.01c.253-1.037-.12-1.558-.516-2.11-.333-.465-.682-.951-.682-1.787v-1.5L2.736 6.733a5.4 5.4 0 0 0 5.46 6.66m3.788-1.762a5.38 5.38 0 0 0 1.406-3.635 5.4 5.4 0 0 0-2.4-4.492v.913H8.988v1.579h-1.5v1.5l4.5-.131v4.26z"
                    />
                  </svg>
                </button>
                <AnimatePresence>
                  {langOpen && (
                    <LanguageDropdown onClose={() => setLangOpen(false)} />
                  )}
                </AnimatePresence>
              </div>
              ...
              {user ? (
                <>
                  <Link
                    to="/profile"
                    className="hidden sm:flex items-center h-11 px-4 text-[0.875rem] font-semibold text-gray-100 bg-gray-10 hover:bg-gray-15 rounded-full transition-colors whitespace-nowrap"
                  >
                    Profile
                  </Link>
                  <button
                    onClick={logout}
                    className="inline-flex items-center justify-center rounded-full font-semibold transition-all duration-200 bg-gray-10 text-gray-100 hover:bg-gray-20 px-4 h-11 text-[0.875rem] whitespace-nowrap"
                  >
                    Sign out
                  </button>
                </>
              ...
              <button className="lg:hidden flex w-11 h-11 items-center justify-center rounded-full bg-gray-10 hover:bg-gray-15 transition-colors">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path
                    fill="#0A0B0D"
                    d="M3.989 3.995a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0 4a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m-1.5 5.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3m2.5-8.5h10v-2h-10zm0 4h10v-2h-10zm0 4h10v-2h-10z"
                  />
                </svg>
              </button>
            </div>

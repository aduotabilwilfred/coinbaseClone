      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-[390px]">
          ...
          <p className="text-[0.9375rem] text-[#8A919E] mb-6 leading-6">
            ...
            helps us keep your account secure by verifying that it&apos;s really
            you.
          </p>
            ...
            {code.map((digit, i) => (
              <input
                ...
                className={`
									...
									${digit ? "border-[#EA580C]" : "border-[#2C2F36]"}
									focus:border-[#EA580C]
								`}
              />
            ))}
          ...
          <p className="text-center text-[0.875rem] text-white">
            Can&apos;t access?{" "}
            <Link to="#" className="text-[#EA580C] hover:underline font-medium">
              Update your 2FA
            </Link>
          </p>
        </div>

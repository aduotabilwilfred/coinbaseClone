...
const StatChart = ({ changePct, statId }) => {
  ...
  `${buildSmoothPath(points)}L${lastPt.x.toFixed(1)},${H}L${firstPt.x.toFixed(1)},${H}Z`;
                      ...
                      {getPageRange().map((p, i) =>
                        p === "..." ? (
                          ...
                          <button
                            ...
                            className={`w-8 h-8 rounded-full flex items-center justify-center text-label-1 transition-colors ${
                              currentPage === p

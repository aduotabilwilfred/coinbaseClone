      ...
      <main className="flex-1 mt-[72px]">
        ...
        <section className="py-12 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-display font-medium mb-8 text-black">
                Featured
              </h2>

              <a
                href="#"
                className="group block relative rounded-2xl overflow-hidden bg-gray-5 border border-transparent hover:border-gray-20 transition-all shadow-sm hover:shadow-md"
              >
                ...
                {popularArticles.map((article, i) => (
                  <div key={i} className="flex flex-col">
                    <a href="#" className="group py-4">
                      <span className="text-xs font-semibold text-gray-50 tracking-wider uppercase mb-1 block">
                        {article.label}
                      </span>
                      <h4 className="text-lg font-medium text-black group-hover:text-blue-60 transition-colors">
                        {article.title}
                      </h4>
                    </a>
                    {i < popularArticles.length - 1 && (
                      <div className="h-px bg-gray-15 w-full"></div>
                    )}
                  </div>
                ))}
              </div>
        ...
        <section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
          <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h2 className="text-3xl font-display font-medium mb-3 text-black">
                Crypto basics
              </h2>
            ...
            <Link
              to="/learn/crypto-basics"
              className="font-semibold text-blue-60 hover:underline shrink-0"
            >
              See more ›
            </Link>
          </div>
        ...
        <section className="py-24 px-6 w-full mx-auto bg-gray-5 border-t border-gray-15">
          <div className="max-w-[800px] mx-auto">
            <div className="mb-12 text-center">
              <h2 className="text-[40px] font-display font-medium text-black">
                What is...
              </h2>
            </div>
            ...
            <div className="flex justify-center">
              <a
                href="#"
                className="px-6 py-3 bg-blue-60 text-white font-medium rounded-lg hover:bg-blue-70 transition-colors"
              >
                See more
              </a>
            </div>
        ...
        <section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
          <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-gray-60 text-lg">
                Ready to advance? Learn the tools and terminology you need to
        ...
        <section className="py-16 px-6 w-full max-w-[1200px] mx-auto border-t border-gray-15">
          <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-gray-60 text-lg">
                Earn yield, dive into crypto apps, control your holdings, and
                much more
              </p>
            </div>
            <a

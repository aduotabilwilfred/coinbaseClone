...
export const SignIn = () => {
    return (
        <div className="min-h-screen bg-gray-100 text-white flex flex-col items-center pt-10 px-6 animate-fade-in">
            <Link to="/" className="self-start mb-16 md:ml-12 lg:ml-20 animate-fade-in-up">
            ...
            <div className="w-full max-w-[420px] mt-10 animate-fade-in-up stagger-1">
                <h1 className="text-3xl font-bold mb-8 text-center font-display">Sign in to Coinbase</h1>
                ...
                <div className="space-y-6">
                    ...
                    <Button variant="primary" className="w-full py-5 text-xl font-bold rounded-full bg-blue-60/20 text-white/50 cursor-not-allowed">
                        Continue
                    </Button>
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-gray-100 text-gray-40 font-bold uppercase tracking-wider">OR</span>
                        </div>
                    </div>

                    <button className="w-full flex items-center justify-center gap-10 py-5 bg-cds-gray-80 hover:bg-gray-70 rounded-full transition-all border border-transparent active:scale-[0.98]">
                ...
                <div className="mt-12 text-center">
                    <p className="text-gray-40 font-sans">
                        Don't have an account? <Link to="/signup" className="text-blue-60 font-medium hover:underline">Sign up</Link>
                    </p>
                </div>
            </div>

            {/* Placeholder for paragraph below the page as requested by user */}
...
export const SignUpForm = () => {
    return (
        <div className="min-h-screen bg-white flex flex-col items-center pt-20 px-6 animate-fade-in">
            <Link to="/" className="mb-12 self-start md:ml-12 lg:ml-20 animate-fade-in-up">
                <img src={coinbaseLogo} alt="Coinbase" className="h-10" />
            </Link>

            <div className="w-full max-w-[500px] animate-fade-in-up stagger-1">
                <h1 className="text-3xl font-bold text-cds-gray-100 mb-2 text-center font-display">Create your account</h1>
                <p className="text-center text-gray-60 mb-8 font-sans">Be sure to use your full legal name as it appears on your government-issued ID.</p>

                <form className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-bold text-cds-gray-100 mb-2 font-sans">First name</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm font-bold text-cds-gray-100 mb-2 font-sans">Last name</label>
                            <input
                                type="text"
                                className="w-full px-4 py-3 border border-cds-gray-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-60 font-sans transition-all hover:border-gray-20"
                            />
                    ...
                    <div>
                        <label className="block text-sm font-bold text-cds-gray-100 mb-2 font-sans">Email</label>
                        <input
                            type="email"
                            className="w-full px-4 py-3 border border-cds-gray-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-60 font-sans transition-all hover:border-gray-20"
                    ...
                    <div>
                        <label className="block text-sm font-bold text-cds-gray-100 mb-2 font-sans">Password</label>
                        <input
                            type="password"
                            className="w-full px-4 py-3 border border-cds-gray-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-60 font-sans transition-all hover:border-gray-20"
                    ...
                    <div className="flex items-start gap-4 p-4 border border-cds-gray-10 rounded-xl bg-gray-5">
                        <input type="checkbox" className="mt-1 w-5 h-5 accent-cds-blue-60 cursor-pointer" />
                        <label className="text-sm font-sans text-cds-gray-80">
                            I certify that I am 18 years of age or older, and agree to the <Link to="#" className="text-blue-60 font-bold hover:underline">User Agreement</Link> and <Link to="#" className="text-blue-60 font-bold hover:underline">Privacy Policy</Link>.
                        </label>
                    </div>

                    <Button variant="primary" className="w-full py-4 text-3xl font-bold uppercase tracking-wide hover:shadow-lg transition-shadow">
                        Create account
                    </Button>
                </form>
                ...
                <div className="mt-8 text-center pb-20">
                    <p className="text-gray-60 font-sans">
                        Already have a Coinbase account? <Link to="/signin" className="text-blue-60 font-bold hover:underline">Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
...
export const EmailSignUp = () => {
    return (
        <div className="min-h-screen bg-gray-100 text-white flex flex-col items-center pt-10 px-6 animate-fade-in">
            <Link to="/" className="self-start mb-16 md:ml-12 lg:ml-20 animate-fade-in-up">
                <img src={coinbaseLogo} alt="Coinbase" className="h-8 invert brightness-0" />
            </Link>

            <div className="w-full max-w-[420px] mt-10 animate-fade-in-up stagger-1">
                <h1 className="text-3xl font-bold mb-3 font-display">Create your account</h1>
                <p className="text-gray-40 mb-8 font-sans">Access all that Coinbase has to offer with a single account.</p>
                ...
                <div className="mt-12 text-center pb-20">
                    <p className="text-gray-40 font-sans">
                        Already have an account? <Link to="/signin" className="text-blue-60 font-medium hover:underline">Sign in</Link>
                    </p>
                </div>
            </div>
                ...
                {signupOptions.map((option, idx) => (
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <h3 className="text-xl font-bold mb-1 font-display">{option.title}</h3>
